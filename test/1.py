# import urllib2
# response = urllib2.urlopen("http://127.0.0.1:3009/api/product/loadtest3")
# print response.read()
import threading
import urllib
import urllib2
...
def getProduct(skip):
	...
	request = urllib2.Request(url,json.dumps({'limit':1,'skip':skip}),headers)
...
for i in range(20):
	t = threading.Thread(target=doLoad,args=(i,))
	t.setDaemon(True)
	t.start()
t.join()
