...
casper.post = function(url, data) {
    return this.evaluate(function _evaluate(url, data) {
...
_.each(categories, function(c) {
    ...
    casper.thenOpen(curl, function() {
        this.waitFor(function check() {
                ...
                var summary = this.getProductSummary();
                //this.post('http://127.0.0.1:3009/api/product/loadtest', { summary: summary });
                ...
                _.each(summary, function(d) {
                    ...
                    casper.thenOpen(baseUrl + d.detailUrl, function() {
                        this.waitFor(function check() {
                            ...
                            this.post('http://127.0.0.1:3009/api/product/loadtest', {product:productDetail})
                        }, function timeout() {
...
casper.then(function() {
    var result = this.post('http://127.0.0.1:3009/api/product/loadtest', { a: 'data' })
